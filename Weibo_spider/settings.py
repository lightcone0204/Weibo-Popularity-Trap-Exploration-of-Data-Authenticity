...
DOWNLOADER_MIDDLEWARES = {
   'Weibo_spider.middlewares.TooManyRequestsRetryMiddleware': 543,
}
...
ITEM_PIPELINES = {
   'Weibo_spider.pipelines.Weibo_spiderPipeline': 300,
}
...
MONGODB_DATABASE = os.environ.get('MONGODB_DATABASE', 'Wangyuan')  #数据库名字
